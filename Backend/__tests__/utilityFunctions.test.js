...
describe('getAvailableSlots', () => {
    test('should return available slots correctly', () => {
        const mockSchedule = {
            '2023-07-23': {
                ...
                status: [0, 1, 1, 0, 0], // '08:30 - 9:00' slot is booked
            },
        };
    ...
    test('should handle service duration correctly', () => {
        const mockSchedule = {
            '2023-07-23': {
                slots: ['08:00', '08:30', '09:00', '09:30', '10:00', '10:30'],
                status: [0, 0, 0, 0, 0, 0], // All slots available
            },
        };
        const serviceDuration = 1.15; // 1 hour and 15 minutes
        const availableSlots = getAvailableSlots(mockSchedule, serviceDuration, {});
        expect(availableSlots).toEqual([
            { date: '2023-07-23', time: '08:00', status: 0, popularity: 0 },
            { date: '2023-07-23', time: '08:30', status: 0, popularity: 0 },
            { date: '2023-07-23', time: '09:00', status: 0, popularity: 0 },
            { date: '2023-07-23', time: '09:30', status: 0, popularity: 0 }
        ]);
    });

    test('should return empty array for zero service duration', () => {
        const mockSchedule = {
            '2023-07-23': {
                slots: ['08:00', '08:30', '09:00', '09:30'],
                status: [0, 0, 0, 0], // All slots available
            },
        };
...
describe('calculateUserPreferences', () => {
    ...
    test('should correctly prioritize recent bookings in case of ties', () => {
        const bookings = [
            { time: '2024-07-30T09:00:00' },
            { time: '2024-07-30T09:30:00' },
            { time: '2024-07-30T09:30:00' },
...
describe('calculatePreferredTimeFromAppointments', () => {
    ...
    test('should return "afternoon" for no appointments', () => {
...
describe('getRecommendedSlots', () => {
    it('should return the top 5 recommended slots based on the given criteria', () => {
        ...
        const userTime = new Date('2021-09-01T08:00:00');
        ...
        const recommendedSlots = getRecommendedSlots(slots, userPreferences, provider, userTime, serviceDuration, preferredPeriod, weights);
        expect(recommendedSlots.length).toBe(5);
        expect(recommendedSlots[0].time).toBe('09:00');
    });

    it('should handle empty slots array', () => {
        const slots = [];
        const userPreferences = ['09:00', '12:00', '15:00'];
        const provider = { schedule: { '2021-09-01': { slots: ['09:00', '9:30', '10:00', '10:30', '11:00', '11:30'], status: [1, 1, 1, 1, 1, 1] } } };
        const userTime = new Date('2021-09-01T08:00:00');
    ...
    it('should calculate higher score for slots closer to user-entered time', () => {
        const slots = [
            { date: '2021-09-01', time: '09:00', popularity: 0.1 },
            { date: '2021-09-01', time: '09:30', popularity: 0.2 }
        ];
        const userPreferences = ['09:00', '12:00', '15:00'];
        const provider = { schedule: { '2021-09-01': { slots: ['09:00', '09:30'], status: [0, 0] } } };
        const userTime = new Date('2021-09-01T09:00:00');
        const serviceDuration = 60;
        const preferredPeriod = 'morning';
        const weights = {
            user_preferences: 0.2,
