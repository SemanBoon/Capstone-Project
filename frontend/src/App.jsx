...
import UserWebSocket from "./Components/UserWebSocket/UserWebSocket";
    ...
    <div className="app">
      ...
      <Router>
          <Routes>
            ...
            <Route path="/provider-homepage/:id" element={<ProviderHomePage />} />
            <Route path="/service-provider-profile/:id" element={<ProviderProfilePage />} />
            <Route path="/service-provider-services/:id" element={<ServicesPage />} />
          </Routes>
